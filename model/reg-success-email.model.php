<?php
    ...
    $phpEmail = "Samuel31036@outlook.com"; // $_POST["emailField"];
    $phpPhone =  "3004360582";//$_POST["phoneField"];
    $phpSubject = "Registro con exito"; //$_POST["subjectField"];
...
<body>
    <div class="welcome-container">
        ...
        <h1>Bienvenido</h1>
        <hr>
        <p> tu participación en <b>Dreamy Event</b> nos llena de alegría.</b></p>
        <p>
            ...
            único, y estamos aquí para hacer que tu experiencia de organización sea lo más sencilla y personalizada
            posible..</p>


        <section class="btn-section">
            <a class="site-Button" href="https://www.google.com">click aqui!
            </a>
